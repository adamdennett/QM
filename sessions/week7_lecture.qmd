...
::::: columns
::: {.column width="50%"}
-   log(PERCTOT) - 1% increase in the unauthorised absence rate predicts a 0.58% decrease in Attainment 8
-   Controlling for absence, all other regions worse attainment than SE. SE uniquely sensitive to absence 
-   interaction shows negative effect of unauthorised absence is significantly less severe in London, NE & Yorkshire
...
-   Interaction Effects (Reference Group value + Other Region coefficient):
    -   log(PTFSM6CLA1A):gor_nameLondon: significant positive coefficient (+0.078684) 
    -   means that the negative effect of disadvantage is less severe in London than in the South East
...
## Multiple Linear Regression - Interaction Effects 
-   Interaction Effects (Reference Group value + Other Region coefficient):
    -   gor_nameLondon:log(PERCTOT): The significant negative coefficient (-0.069792) 
    -   means that the negative effect of Overall Absence is more severe in London than in the South East
...
::: callout-tip
-   Interpreting interaction effects is HARD
...
## Thoughts regression model building
...
-   Algorithms like the Step-Wise algorithm can automate the process of variable selection - worth experimenting with, but no substitute for doing your research!
